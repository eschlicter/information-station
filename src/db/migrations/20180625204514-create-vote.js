...
module.exports = {
 ...
 // If we delete the associated post, we delete the votes associated with it as well.
      postId: {
        type: Sequelize.INTEGER,
        onDelete: "CASCADE",
        allowNull: false,
 ...
 // If we delete the associated user, we delete the votes associated with it as well.
      userId: {
        type: Sequelize.INTEGER,
        onDelete: "CASCADE",
        allowNull: false,
